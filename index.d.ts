...
export declare namespace Schema {
	 ...
	 */
	interface ObjectSchema<TProperties extends Record<string, Schema>, TRequired extends keyof TProperties> {
		/** The schema type. */
...
export declare namespace TypeOf {
	 ...
	 * The type function to derive the type of schemas.
	 */
	type ObjectSchema<T extends Schema> = T extends Schema.ObjectSchema<infer P, infer R> ? ObjectSchema.Flatten<{
...
declare class SchemaFactories {
	 ...
	 * @param options The options.
	 */
	number({ allowNaN, finiteOnly, intOnly, maxValue, minValue, }?: Omit<Schema.NumberSchema, "type">): Schema.NumberSchema;
	/**
	 ...
	 */
	object<TProperties extends Record<any, Schema>>(properties: TProperties): Schema.ObjectSchema<TProperties, keyof TProperties>;
	/**
	 * The schema for plain objects. All properties are optional.
	 * @param properties The schema of known properties.
	 */
	partialObject<TProperties extends Record<any, Schema>>(properties: TProperties): Schema.ObjectSchema<TProperties, never>;
	/**
	 * The schema for plain objects.
	 * @param properties The schema of known properties.
	 * @param required The names of required properties.
	 */
	partialObject<TProperties extends Record<any, Schema>, TRequired extends (keyof TProperties)[]>(properties: TProperties, required: TRequired): Schema.ObjectSchema<TProperties, TRequired[number]>;
	/**
	 * The schema for any objects.
	 */
